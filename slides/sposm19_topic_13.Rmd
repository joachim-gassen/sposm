...
access services from servers in a stateless and cacheable way using uniform
interfaces
- This allows clients to be developed indepenently from servers and data to be 
